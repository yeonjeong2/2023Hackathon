...
export default function Map({changeSearch, changeXdir,changeYdir}) {
    var markers = [];
    let presentPosition;
    ...
    useEffect(() => {
        ...
        // 현위치 받아오기, HTML5의 geolocation으로 사용할 수 있는지 확인합니다 
        ...
        function displayPlaces(places) {
            ...
            for (var i = 0; i < places.length; i++) {
                ...
                (function (marker, title, dirx, diry) {
        ...
        <div>
            ...
            <div id="menu_wrap" className="bg_white">
                <div className="option">
                    <div>
                        <form className="form">
                            키워드 : <input onChange={(e) => setSearchData(e.target.value)}
                                type="text" value={searchData} id="keyword" size="15" />
